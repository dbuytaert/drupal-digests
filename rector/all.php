...
require_once __DIR__ . '/rules/replace-deprecated-drupal-core-entity-query-sql-pgsql-3488572.php';
...
return RectorConfig::configure()
    ->withRules([RemoveOptionsArgFromConstraintConstructorRector::class, ReplaceNonBoolAccessRector::class, ReplaceNodeAccessGrantsFunctionRector::class, ReplacePluginBaseIsConfigurableRector::class, NodeAccessRebuildFunctionsRector::class, GetOriginalClassToGetDecoratedClassesRector::class, RemoveTwigNodeTransTagArgRector::class, RemoveToolkitArgFromImageToolkitOperationConstructorRector::class, CommentLinkBuilderConstructorRector::class, RemoveFilterTipsLongParamRector::class, AddLegacyModuleImplementsAlterAttributeRector::class, RemoveModuleHandlerDeprecatedMethodsRector::class, RemoveStateCacheSettingRector::class, AddTimeInterfaceToPluginConstructorsRector::class, RemoveTrustedDataConceptRector::class, ViewsUiAdminDeprecatedFunctionsRector::class, RemoveSourceModuleFromMigrateSourceAttributeRector::class, CommentUriToPermalinkRector::class, RenameHookRankingRector::class, NodeAccessViewAllNodesRector::class, NodeViewsDataModuleExtensionListRector::class, DeprecatedTemplatePreprocesCallsRector::class, ViewsAddContextualLinksRector::class, FilterFormatFunctionsToServiceRector::class, TwigEngineFunctionsRector::class, RemoveInstallSchemaSystemSequencesRector::class, RemoveRootFromCreateConnectionOptionsFromUrlRector::class, CommentPreviewModeRector::class, NavigationMessageThemeToComponentRector::class, FieldPurgeBatchRector::class, SystemPerformanceGzipToCompressRector::class, GetNameToNameRector::class, AddPluginManagerAttributeClassRector::class, LanguageModuleFunctionDeprecationsRector::class, RenameHelpSearchToSearchHelpSearchRector::class, HtaccessWriterSettingsArgumentRector::class, RemoveRouteBuilderDeprecatedArgsRector::class, SystemSortThemesRector::class, MenuActiveTrailPathMatcherRector::class, RemoveTemplatePreprocessCallRector::class, RemoveSetUriCallbackRector::class, RemoveEntityReferenceRecursiveLimitConstantRector::class, BlockContentSelectionExtendsRector::class, SystemRegionFunctionsRector::class, RemoveViewsUiContextualLinksSuppressRector::class, ViewsEntityFieldLabelRector::class, PassEntityTypeManagerToNodePermissionsRector::class, RemoveLinkWidgetValidateTitleElementRector::class, AddEventDispatcherToJsonApiConstructorRector::class, BlockContentTestBaseStringToArrayRector::class, DeprecatedFilterFunctionsRector::class, RenameI18nQueryTraitRector::class, NodePreviewControllerConstructorRector::class, AddFileUrlGeneratorToAttachmentsProcessorRector::class, NodeStorageDeprecatedMethodsRector::class, GroupLegacyToIgnoreDeprecationsRector::class, RemoveUpdaterPostInstallMethodsRector::class, MovePointerToMouseOverRector::class, ReplaceAddCachedDiscoveryMethodCallRector::class, AlphadecimalToIntNullOrEmptyRector::class, MigrateSqlGetMigrationPluginManagerRector::class, DrupalGetHeadersAssocArrayRector::class, EditorLoadDeprecationRector::class, EntityFormModeEmptyDescriptionToNullRector::class, RemoveAddToAssertionCountFromSetUpRector::class, UpdateMainContentViewSubscriberConstructorRector::class, RenameResourceResponseValidatorRector::class, RemoveDefineExtraOptionsOverrideRector::class, ReplaceDrupalCommonThemeRector::class, NodeAddBodyFieldRector::class, ViewsFieldDefaultViewsDataRector::class, ConvertHookRequirementsRuntimeRector::class, HookRequirementsAlterRenameRector::class, FormLocationRector::class, FileGetContentHeadersRector::class, EntityTestBundleFunctionsRector::class, RemoveAliasManagerCacheMethodCallsRector::class, RecipeRunnerInstallModuleRector::class, FieldgroupToFieldsetRector::class, LocaleTranslateGetInterfaceTranslationFilesRector::class, RemoveCacheTagChecksumAssertionsRector::class, UserSessionNamePropertyToGetAccountNameRector::class, SessionSuperGlobalToRequestSessionRector::class, ViewsBlockItemsPerPageNoneToNullRector::class, RemoveDeprecatedUpdateManagerFuncCallsRector::class, RemoveRendererAddCacheableDependencyNonObjectRector::class, AddComponentPluginManagerToThemeInstallerRector::class, RemoveRootFromConvertDbUrlToConnectionInfoRector::class, RemoveModuleHandlerAddModuleCallsRector::class, FixContentEntityStorageBaseGetSignatureRector::class, ErrorCurrentErrorHandlerRector::class, ViewsConfigUpdaterClassResolverToServiceRector::class, FileSystemBasenameToNativeRector::class, NodeMassUpdateToNodeBulkUpdateRector::class, TaxonomyTermPageVariableToViewModeRector::class, RemoveBlockContentAddBodyFieldRector::class, NodeTypeGetDescriptionRector::class, FileManagedFileSubmitRector::class, LoadAllIncludesRector::class, NodeSetPreviewModeRector::class, ContentTranslationAdminFunctionsRector::class, CommentManagerGetCountNewCommentsRector::class, AddRunTestsInSeparateProcessesAttributeRector::class, RemoveHasNamedArgumentsAttributeRector::class, WorkspacesAssociationToTrackerRector::class, RemoveDrupalToStringTraitRector::class, ReplaceExpectDeprecationRector::class, ReplaceItemAttributesWithAttributesRector::class, AddSymfonyConstraintConstructorRector::class, AddStringTypeToGetBundleInfoRector::class, GuardGetPropertyDefinitionNullArgRector::class, ReplaceDblogProceduralFunctionsRector::class, UploadedFileConstraintArrayOptionsToNamedArgsRector::class, RemoveViewsRowCacheKeysRector::class, UseEntityTypeHasIntegerIdRector::class, ViewsPluginHandlerManagerRector::class, RemoveAutomatedCronSettingsSubmitHandlerRector::class, ReplaceCkeditor5ProceduralFunctionsRector::class, ReplaceContactDeprecatedFunctionsRector::class, ReplaceFieldUiFormManageFieldFormSubmitRector::class, DeprecatedImageFunctionsRector::class, ReplaceContextualProceduralFunctionsRector::class, MediaFilterFormatEditFormValidateRector::class, EditorFilterXssRector::class, TextSummaryFunctionToServiceRector::class, ReplaceLocaleTranslationIncFunctionsRector::class, ReplaceDeprecatedMediaLibraryFunctionsRector::class, ReplaceEditorImageUploadSettingsFormRector::class, AddObjectTypeToExecuteMethodRector::class, AddLabelKeyParamToCategorizingPluginManagerRector::class, ReplaceDialogClassOptionRector::class, ReplaceLibraryDiscoveryClassRector::class, ReplaceModuleHandlerGetNameRector::class, EntityOriginalPropertyToMethodRector::class, ReplaceRebuildThemeDataRector::class, ReplaceTemplatePreprossLayoutRector::class, ReplaceDeprecatedMenuUiFunctionsRector::class, ReplaceLocaleTranslationPathConfigRector::class, ReplaceDeprecatedNodeFunctionsRector::class, ReplaceDeprecatedViewsFunctionsRector::class, AddCacheTagsChecksumReturnTypesRector::class, ReplaceLocaleFetchFunctionsRector::class, ReplaceThemeGetSettingRector::class, ReplaceRemovedImageResponsiveImageFunctionsRector::class, ReplaceDatetimeDeprecatedApisRector::class, ReplaceRequirementConstantsRector::class, RemoveCacheExpireOverrideRector::class, ReplaceSessionManagerDeleteRector::class, AddTwigImplementationReturnTypesRector::class, AddSupportAwareSectionStorageInterfaceRector::class, ReplaceCommentDeprecatedConstantsRector::class, RemoveMigrationDependenciesExpandArgRector::class, ReplaceFileExistsConstantsRector::class, ConstraintViolationToInterfaceRector::class, CreateMockToCreateStubRector::class, ReplaceUserFormProcessPasswordConfirmRector::class]);
